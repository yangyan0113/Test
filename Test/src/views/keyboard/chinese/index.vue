  ...
  <div class="app-container">
    ...
    >
      <el-form-item label="标题" prop="title">
        <el-input
          v-model="queryParams.titletitle"
          placeholder="请输入标题"
          clearable
          size="small"
      ...
      <el-form-item label="练习类别" prop="seriesBig">
        <el-select
          v-model="queryParams.seriesBig"
          placeholder="请选择练习类别"
          @change="handleShowSmallCode"
        >
          <el-option
...
export default {
  ...
  methods: {
    ...
    showKeyData(row) {
      ...
      this.$router.push({ path: '/cdetail', query: { keyboardId } })
    },
    //根据选择的大系列，显示小系列
    handleShowSmallCode() {
      if (this.queryParams.seriesBig) {
        //console.log('this.queryParams.seriesBig=' + this.queryParams.seriesBig)
