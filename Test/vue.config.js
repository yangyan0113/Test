...
module.exports = {
  ...
  //例如，如果你的应用被部署在 https://www.baidu.com/admin/，则设置 baseUrl 为 /admin/。
  ...
  devServer: {
    ...
    port: 60, // 项目启动port,nginx配置文件中设置的端口server-listen
    open: true,
    proxy: {
      // detail: https://cli.vuejs.org/config/#devserver-proxy
      [process.env.VUE_APP_BASE_API]: {
        target: 'http://124.71.187.111:6666/', // 后端接口地址
        changeOrigin: true,
        pathRewrite: {
          ['^' + process.env.VUE_APP_BASE_API]: '' //需要rewrite的
			...
			"msgHub": {
				target: 'http://124.71.187.111:6666/msgHub',
				ws: true,
				changeOrigin: true,
				pathRewrite: {
          ['^/msgHub']: '' //需要rewrite的
